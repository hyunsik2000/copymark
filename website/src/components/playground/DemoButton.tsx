...
import { defaultButtonOptions } from "./options";
...
export function DemoButton() {
  ...
  return (
    <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
      <h2 className="text-xl font-semibold text-slate-900">CopyButton</h2>
      ...
      <div className="mt-6 rounded-2xl border border-black/5 bg-[#1e1e1e] p-4 text-slate-100">
